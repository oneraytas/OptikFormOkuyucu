...
## Nasıl Kullanılıyor ? 
 [+] Önce ana klasörde pdfler diye bir klasör yarat. Bu klasör içine tarayıcıdan tarattığın belgeyi/belgeleri koy. 
    Örn; <img width="233" height="262" alt="image" src="https://github.com/user-attachments/assets/5c7d8ecb-2194-4347-bfbb-d8dd95842e28" />
 ...
 [+]İlk Jupyter hücresini çalıştır. Bu hücre optik_kirpilmis_resimler adında bir klasör oluşturacak ve kırptığı optikleri koyacak
    Örn; <img width="117" height="180" alt="bos_sinav_sayfa_1" src="https://github.com/user-attachments/assets/4f88e618-8a68-4bb0-be6f-f4705a6e16dd" />
